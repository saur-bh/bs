...
trading_order_form_trailing_stop_exchange_normal
    ...
    Create Trailing Stop Order    20000    0.0025    buy
    Create Trailing Stop Order    10000    0.0025    sell
    
trading_order_form_trailing_stop_exchange_tif
    Create Trailing Stop Order    20000    0.0025    buy    tif=${True}
    Create Trailing Stop Order    10000    0.0025    sell    tif=${True}
