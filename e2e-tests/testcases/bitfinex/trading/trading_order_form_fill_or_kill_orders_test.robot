...
trading_order_form_fill_or_kill_exchange_normal
    ...
    Create Fill Or Kill Order    20000    0.0025    buy    confirm=${False}
    Verify Price Warning Popup
    Create Fill Or Kill Order    10000    0.0025    sell    confirm=${False}
    Verify Price Warning Popup
    Create Fill Or Kill Order    10000    0.0025    buy
