...
...    AND    Login And Set Up Pin    ${TEST_DATA_BASIC_28FEB2022_KEY}    ${TEST_DATA_BASIC_28FEB2022_SECRET}    Staging
Suite Teardown    Close Test Application
*** Test Cases ***
staging_basic_after_27feb2022_trading
    ...
    Verify Label Displays    Verify your account to Intermediate (or above) in order to proceed
    ...
    Verify Label Displays    Verify your account to Intermediate (or above) in order to proceed    swipe=DOWN
    
staging_basic_after_27feb2022_derivatives
    Tap On Back Button
...
staging_basic_after_27feb2022_funding
    Tap On Back Button
    Tap On Navigation Tab By Name    Funding
    Access Trading Pair On Funding    USD
    Verify Label Displays    Verify your account to Intermediate (or above) in order to proceed    swipe=DOWN
    
staging_basic_after_27feb2022_borrow
    Tap On Back Button
    Tap On Navigation Tab By Name    Account
    Tap On Account Menu Item    Borrow
    Verify Label Displays    In order to proceed with borrowing, please verify your account to Intermediate or above
    
# staging_intermediate_after_27feb2022_trading
    # Close Test Application
    # Open Apps    Bitfinex
    # Login And Set Up Pin    ${TEST_DATA_INTERMIDIATE_010322_API_KEY}    ${TEST_DATA_INTERMIDIATE_010322_API_SECRET}    Staging
    # Access Trading Pair    BTCUSD
    # Swipe To Panel    ORDER BOOK    0.1    DOWN
    # Select Order Form Tab    Margin
    # Select Order Type    Limit
    # Verify Label Not Display    Verify your account to Intermediate (or above) in order to proceed
