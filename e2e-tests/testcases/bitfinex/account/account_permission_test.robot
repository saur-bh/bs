...
no_get_account_information_verification
    Open Apps    Bitfinex
    Login And Set Up Pin    ${TEST_DATA_FULL_VERIFIED_NO_GET_ACCOUNT_INFORMATION_API_KEY}    ${TEST_DATA_FULL_VERIFIED_NO_GET_ACCOUNT_INFORMATION_API_SECRET}    Production
...
no_edit_account_information_verification
    Open Apps    Bitfinex
    Login And Set Up Pin    ${TEST_DATA_FULL_VERIFIED_NO_EDIT_ACCOUNT_INFORMATION_API_KEY}    ${TEST_DATA_FULL_VERIFIED_NO_EDIT_ACCOUNT_INFORMATION_API_SECRET}    Production
    Tap On Navigation Tab By Name    Account
    Tap On Account Menu Item    Verification
